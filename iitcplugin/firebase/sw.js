(function () {
    ...
    ***************************************************************************** */
    ...
    function getDbPromise$1() {
        if (!dbPromise$1) {
            dbPromise$1 = idb.openDb(DATABASE_NAME$1, DATABASE_VERSION$1, upgradeDB => {
    ...
    async function migrateOldDatabase(senderId) {
        ...
        const db = await idb.openDb(OLD_DB_NAME, OLD_DB_VERSION, async (db) => {
            var _a;
            if (db.oldVersion < 2) {
    ...
    onBackgroundMessage(messaging, function (payload) { return __awaiter(void 0, void 0, void 0, function () {
        var allClients, _i, allClients_1, client;
            ...
            switch (_a.label) {
                ...
                case 1:
                    ...
                    if (allClients.length === 0) {
                        ...
                        for (_i = 0, allClients_1 = allClients; _i < allClients_1.length; _i++) {
